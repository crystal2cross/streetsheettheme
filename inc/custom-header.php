...
add_action( 'after_setup_theme', 'streetsheettheme_custom_header_setup' );

if ( ! function_exists( 'streetsheettheme_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see streetsheettheme_custom_header_setup().
 */
function streetsheettheme_header_style() {
