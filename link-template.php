...
function get_the_post_navigation( $args = array() ) {
	...
	if ( $previous || $next ) {
		$navigation = _navigation_markup( $previous . '<div class="nav-home"><a href="#top">Top</a></div>' . $next, 'post-navigation', $args['screen_reader_text'] );
	}
...
function get_the_posts_navigation( $args = array() ) {
	...
	if ( $GLOBALS['wp_query']->max_num_pages > 1 ) {
		...
		if ( $prev_link ) {
                    ...
                    $navigation .= '<div class="nav-previous-none">.</div>';
                }
		...
		$navigation = _navigation_markup( $navigation, 'posts-navigation', $args['screen_reader_text'] );
            ...
            $navigation = _navigation_markup( $navigation, 'posts-navigation', 'Posts navigation' );
        }
